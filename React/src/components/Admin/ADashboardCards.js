                ...
                <div class="card-group">
                    ...
                    <div class="card-wrap mt-3" >
                        <div class="card-header six">
                            <i class="fab fa-js-square">72</i>
                        </div>
                        <div class="card-content">
                            <br />
                            <button class="card-btn six">Customers List</button>
                        </div>
                    </div>
                    </div>
                    <div>
                    <div class="card-wrap ms-5 mt-3">
                        <div class="card-header seven">
                            <i class="fab fa-js-square">34</i>
                        </div>
                        <div class="card-content">
                            <br />
                            <button class="card-btn seven">Suppliers List</button>
                        </div>
                    </div>
                    </div>
                </div>
